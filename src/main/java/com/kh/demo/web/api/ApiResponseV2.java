...
public class ApiResponseV2<T> {
  ...
  private ApiResponseV2(Header header, T body, int totalCnt) {
    this.header = header;
    this.body = body;
  ...
  public static <T> ApiResponseV2<T> createApiResponse(String rtcd, String rtmsg, T body){
    int totalCnt = 0;
    ...
    return new ApiResponseV2<>(new Header(rtcd,rtmsg), body, totalCnt);
  }
}